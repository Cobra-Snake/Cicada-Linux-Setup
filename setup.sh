...
"ltrace" "nuclei" "dirb" "dirsearch" "dirbuster" "netexec" "fastfetch" "backdoor-factory" "anew" "powercat"
"crackmapexec" "evil-winrm" "crunch" "legion" "set" "recon-ng" "sublist3r" "airgeddon" "gedit""adaptixc2"
